...
os.environ['CUDA_VISIBLE_DEVISES']='2'
def main():
    # Hyper Parameters
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', default='/data4/weijiwei/data',
    ...
    parser.add_argument('--model_name', default='./runs/runX/checkpoint1',
