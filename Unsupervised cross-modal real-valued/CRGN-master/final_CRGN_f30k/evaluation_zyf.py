...
def encode_data(model, data_loader, log_step=10, logging=print):
    ...
    for i, (oimages, images, captions, lengths, ids) in enumerate(data_loader):
        # make sure val logger is used
        model.logger = val_logger

        # compute the embeddings
        img_emb, cap_emb, oimg_emb = model.forward_emb(oimages, images, captions, lengths, volatile=True)
