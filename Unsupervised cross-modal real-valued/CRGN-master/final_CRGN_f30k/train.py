...
def main():
    ...
    parser.add_argument('--data_path', default='/data3/zhangyf/cross_modal_retrieval/SCAN/data',
                        help='path to datasets')
    parser.add_argument('--data_name', default='f30k_precomp',
                        help='{coco,f30k}_precomp')
    parser.add_argument('--vocab_path', default='/data3/zhangyf/cross_modal_retrieval/SCAN/vocab/',
    ...
    parser.add_argument('--resume', default='/data3/zhangyf/cross_modal_retrieval/vsepp_next_train_12_31_f30k/run/coco_vse++_ft_128_f30k_next/model_best.pth.tar', type=str, metavar='PATH',
    ...
    for epoch in range(opt.num_epochs):
        ...
        # train for one epoch
        bset_rsum = train(opt, train_loader, model, epoch, val_loader, best_rsum)
    ...
    for i, train_data in enumerate(train_loader):
        ...
        if model.Eiters % opt.val_step == 0:
            ...
            save_checkpoint({
                ...
                'opt': opt,
                'Eiters': model.Eiters,
            }, is_best, filename='checkpoint_{epoch}_{zyf}.pth.tar'.format(epoch=str(epoch), zyf=str(zzz)), prefix=opt.model_name + '/')
            zzz = zzz + 1
