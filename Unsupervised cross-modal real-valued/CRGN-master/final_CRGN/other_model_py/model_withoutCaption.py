...
class SCAN(object):
    ...
    def __init__(self, opt):
        ...
        self.img_enc = nn.DataParallel(self.img_enc, device_ids=[0,1]).cuda()
    ...
    def state_dict(self):
        state_dict = [self.oimg_enc.state_dict(), self.txt_enc.state_dict(), self.img_enc.state_dict()]
        return state_dict
    ...
    def train_emb(self, oimages, images, captions, lengths, ids=None, *args):
        ...
        img_emb, cap_emb, oimg_emb  = self.forward_emb(oimages, images, captions, lengths)
