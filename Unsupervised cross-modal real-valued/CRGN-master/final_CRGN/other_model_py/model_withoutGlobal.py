...
class SCAN(object):
    ...
    def __init__(self, opt):
        ...
        self.img_enc = EncoderImage(opt.data_name, opt.img_dim, opt.embed_size, finetune=opt.finetune,
    ...
    def state_dict(self):
        state_dict = [self.txt_enc.state_dict(), self.img_enc.state_dict(), self.decoder.state_dict()]
        return state_dict
