...
class EncoderImagePrecomp(nn.Module):
    ...
    def __init__(self, img_dim, embed_size, no_imgnorm=False):
        ...
        self.wg = nn.Linear(gx_dim, embed_size)
        self.ul = nn.Linear(img_dim, embed_size)
        self.ug = nn.Linear(gx_dim, embed_size)
    ...
    def init_weights(self):
        ...
        r = np.sqrt(6.) / np.sqrt(self.wg.in_features +
                                  self.wg.out_features)
        self.wg.weight.data.uniform_(-r, r)
        self.wg.bias.data.fill_(0)
    ...
    def forward(self, images, oimages):
        ...
        if not self.no_imgnorm:
            ...
            featureswg = l2norm(featureswg, dim=-1)

        features = torch.cat((featuresp,torch.unsqueeze(featureswg,1)),1)     
