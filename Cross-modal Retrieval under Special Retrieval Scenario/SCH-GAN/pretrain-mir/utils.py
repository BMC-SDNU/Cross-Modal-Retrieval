...
def load_all_query_url(list_dir, label_dim):
	...
	database_label = open(list_dir + 'database_label.txt', 'r').read().split('\r\n')
	...
	test_i2t, test_i2t_pos = make_test_dict(test_img, database_txt, test_label, database_label, label_dim)
	test_t2i, test_t2i_pos = make_test_dict(test_txt, database_img, test_label, database_label, label_dim)
	
	print('Training num %d' % len(train_i2t))
	print('Testing num %d' % len(test_i2t))
