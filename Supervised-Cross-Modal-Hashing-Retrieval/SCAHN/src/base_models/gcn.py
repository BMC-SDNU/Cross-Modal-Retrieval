...
class GCN(nn.Cell):
    ...
    def __init__(self, input_dim, output_dim, hidden, dropout):
        super(GCN, self).__init__()
        self.layer0 = GraphConvolution(input_dim, hidden, activation="leakyrelu", dropout_ratio=dropout)
        self.layer1 = GraphConvolution(hidden, output_dim, dropout_ratio=None)
...
class GCN_GPU(nn.Cell):
    ...
    def __init__(self, input_dim, output_dim, hidden, dropout, adj):
