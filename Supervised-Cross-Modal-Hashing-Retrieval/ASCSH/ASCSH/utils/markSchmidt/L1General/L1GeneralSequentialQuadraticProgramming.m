...
options = optimset('Display','none','LargeScale','off','MaxIter',100000,'Algorithm','active-set');
...
for i = 1:maxIter
    ...
    if order == 2
        [t,w,f,g,LSfunEvals,H] = ArmijoBacktrack(w_old,t,d,f,f,g,gtd,1e-4,2,0,optTol,...
            1,0,0,wrapGradFunc,wrapGradArgs{:});
    else
        [t,w,f,g,LSfunEvals] = ArmijoBacktrack(w_old,t,d,f,f,g,gtd,1e-4,2,0,optTol,...
